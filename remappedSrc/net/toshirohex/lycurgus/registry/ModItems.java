...
import net.toshirohex.lycurgus.overwrites.tools.KingCotton;
...
public class ModItems {
    ...
    public static final KingCotton KING_COTTON = new KingCotton(Materials[3], +10, +5.0F, ITEM_GROUP);
    ...
    public static void registerItems() {
        String Names[] = {"toe", "toest", "steel_ingot", "hands_cold_ingot", "endium_ingot",
                ...
                "greatsword", "knightly_katana", "steel_tool", "hands_cold_tool", "endium_tool", "king_cotton",
                "pistol"};
